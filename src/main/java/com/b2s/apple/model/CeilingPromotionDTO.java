 ...
 */
public class CeilingPromotionDTO {

    private final int points;

    private CeilingPromotionDTO(final Builder builder) {
    ...
    @JsonCreator
    public static CeilingPromotionDTO create(@JsonProperty("points") final Integer thePoints) {
        return builder()
    ...
    public boolean equals(final Object o) {
        ...
        final CeilingPromotionDTO other = (CeilingPromotionDTO) o;
    ...
    public static final class Builder {
        ...
        public CeilingPromotionDTO build() {
            return Exceptions.illegalArgumentToIllegalState(() -> new CeilingPromotionDTO(this));
        }
    }
}
