...
@Entity
public class OrderLineTaxEntity implements Serializable {

    @EmbeddedId
    private OrderLineTaxId orderLineTaxId;
    ...
    public OrderLineTaxId getOrderLineTaxId() {
        return orderLineTaxId;
    }

    public void setOrderLineTaxId(final OrderLineTaxId orderLineTaxId) {
        this.orderLineTaxId = orderLineTaxId;
    }

    @Embeddable
    public static class OrderLineTaxId implements Serializable {
        ...
        public boolean equals(final Object o) {
            ...
            final OrderLineTaxId that = (OrderLineTaxId) o;
