 ...
 */
public class EpsilonSAMLResponseException extends Exception {
     ...
     */
    private EpsilonSAMLResponseException(final Code code) {
     ...
     */
    private EpsilonSAMLResponseException(final Code code, final String additionalText) {
     ...
     */
    private EpsilonSAMLResponseException(final Code code, final Throwable cause) {
     ...
     */
    public static EpsilonSAMLResponseException fromCode(final Code theCode) {
        return new EpsilonSAMLResponseException(theCode);
    }
     ...
     */
    public static EpsilonSAMLResponseException fromCode(final Code theCode, final String additionalText) {
        return new EpsilonSAMLResponseException(theCode, additionalText);
    }
     ...
     */
    public static EpsilonSAMLResponseException fromCode(final Code theCode, final Throwable cause) {
        return new EpsilonSAMLResponseException(theCode, cause);
    }
