 ...
 */
public class AddressValidatorPHImpl extends AddressValidatorImpl {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("AddressValidatorPHImpl{");
        sb.append(CommonConstants.COUNTRY_CODE_PH);
        sb.append('}');
        return sb.toString();
    }
}
