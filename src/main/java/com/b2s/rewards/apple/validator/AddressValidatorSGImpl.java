...
import static com.b2s.rewards.apple.validator.AddressValidatorConstants.ZIP_LENGTH_6;

/**
 * Created by vprasanna on 11/17/2017.
 */
public class AddressValidatorSGImpl extends AddressValidatorImpl {
    ...
    public boolean hasValidationError(final Address address, final MessageSource messageSource, final User user) {
        ...
        //Zip length 6
        mandatoryZipCheck(address, ZIP_LENGTH_6, messageSource, userLocale);
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("AddressValidatorSGImpl{");
        sb.append(CommonConstants.COUNTRY_CODE_SG);
        sb.append('}');
        return sb.toString();
    }
}
