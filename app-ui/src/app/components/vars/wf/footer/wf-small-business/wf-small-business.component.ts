...
@Component({
  selector: 'app-wf-small-business-footer',
  templateUrl: './wf-small-business.component.html',
  styleUrls: ['./wf-small-business.component.scss']
})
export class WFSmallBusinessFooterComponent implements OnInit, Footer {
