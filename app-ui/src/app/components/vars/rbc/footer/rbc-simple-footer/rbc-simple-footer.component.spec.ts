...
import { RBCSimpleFooterComponent } from './rbc-simple-footer.component';

describe('RBCSimpleFooterComponent', () => {
  let component: RBCSimpleFooterComponent;
  let fixture: ComponentFixture<RBCSimpleFooterComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ RBCSimpleFooterComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RBCSimpleFooterComponent);
