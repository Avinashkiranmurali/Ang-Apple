...
import { AddressFormMyComponent } from './address-form-my.component';
...
describe('AddressFormMyComponent', () => {
  let component: AddressFormMyComponent;
  let fixture: ComponentFixture<AddressFormMyComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ AddressFormMyComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddressFormMyComponent);
