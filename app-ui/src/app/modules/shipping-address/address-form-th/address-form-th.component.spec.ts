...
import { AddressFormThComponent } from './address-form-th.component';
...
describe('AddressFormThComponent', () => {
  let component: AddressFormThComponent;
  let fixture: ComponentFixture<AddressFormThComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [AddressFormThComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddressFormThComponent);
