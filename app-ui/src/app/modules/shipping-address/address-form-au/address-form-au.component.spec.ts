...
import { AddressFormAuComponent } from './address-form-au.component';
...
describe('AddressFormAuComponent', () => {
  let component: AddressFormAuComponent;
  let fixture: ComponentFixture<AddressFormAuComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ AddressFormAuComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddressFormAuComponent);
