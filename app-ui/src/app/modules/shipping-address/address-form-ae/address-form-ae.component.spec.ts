...
import { AddressFormAeComponent } from './address-form-ae.component';
...
describe('AddressFormAeComponent', () => {
  let component: AddressFormAeComponent;
  let fixture: ComponentFixture<AddressFormAeComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ AddressFormAeComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddressFormAeComponent);
