...
import { AddressFormSgComponent } from './address-form-sg.component';
...
describe('AddressFormSgComponent', () => {
  let component: AddressFormSgComponent;
  let fixture: ComponentFixture<AddressFormSgComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ AddressFormSgComponent ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddressFormSgComponent);
